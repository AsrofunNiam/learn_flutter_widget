...
import 'package:learn_flutter_widget/view/home_view/main_view_layouts/view_wrap/view_wrap_one.dart';

class RouteWrap extends StatefulWidget {
  const RouteWrap({Key? key}) : super(key: key);
...
class _RouteWrapState extends State<RouteWrap> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Center(child: Text("Route Wrap")),
        ),
        body: Center(
          child: Container(
